...
describe('LoginComponent', () => {
  ...
  it('should return valid login form is username is set', function () {
    ...
    expect(fixture.debugElement.nativeElement.querySelector('#err-username')).toBeNull()
  });
  ...
  it('should return invalid login form if username is empty', function () {
    ...
    expect(fixture.debugElement.nativeElement.querySelector('#err-username')).toBeDefined()
  });
  ...
  it('should return valid login form if password is set', function () {
    ...
    expect(fixture.debugElement.nativeElement.querySelector('#err-password')).toBeNull()
  });
  ...
  it('should return invalid login form if password is not set', function () {
    ...
    expect(fixture.debugElement.nativeElement.querySelector('#err-password')).toBeDefined()
  });

  it('should enable login button when username and password is set', function () {
    expect(fixture.debugElement.nativeElement.querySelector('#login-btn').disabled).toBeTruthy()
    component.loginForm.get('username')?.setValue('username')
    component.loginForm.get('password')?.setValue('password')

    fixture.detectChanges()

    expect(fixture.debugElement.nativeElement.querySelector('#login-btn').disabled).toBeFalsy()
  });
